      ...
      <div class="container px-6 py-3 mx-auto">
        <div class="flex items-center justify-between">
          <div class="hidden w-full text-gray-600 sm:flex sm:items-center">
            ...
            <span class="mx-1 text-sm">FL</span>
          </div>
          ...
          <div class="flex items-center justify-end sm:w-full space-x-4">
            ...
            <div class="flex sm:hidden">
              <button type="button" class="text-gray-600 hover:text-gray-500 focus:outline-none focus:text-gray-500" aria-label="toggle menu" @click="mobileOpen = !mobileOpen">
        ...
        <nav :class="mobileOpen ? '' : 'hidden'" class="mt-4 sm:flex sm:justify-center sm:items-center">
        ...
        <div class="relative max-w-lg mx-auto mt-6">
          ...
          <input class="w-full py-2 pl-10 pr-4 border rounded-md focus:border-blue-500 focus:outline-none focus:shadow-outline" type="text" placeholder="Search">
        </div>
      </div>
    </header>
    <div :class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'" class="fixed top-0 right-0 w-full h-full max-w-xs px-6 py-4 overflow-y-auto transition duration-300 transform bg-white shadow-2xl">
      <div class="flex items-center justify-between">
